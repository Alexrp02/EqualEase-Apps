...
class PictogramSelect extends StatefulWidget {
  const PictogramSelect({super.key});

  @override
  _PictogramSelectState createState() => _PictogramSelectState();
}

class _PictogramSelectState extends State<PictogramSelect> {
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      ...
                      onTap: () {
                        ...
                        //   _selectPhoto(index);
                        // }
                        Navigator.pop(context, _images[index]['url']);
                      },
                      child: Container(
